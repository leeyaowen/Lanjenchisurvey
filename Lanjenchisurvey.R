...
#測試
q11<-filter(dt,X1==36,Y1==38,X2==1,Y2==1)
q12<-filter(dt,X1==36,Y1==38,X2==1,Y2==2)
q22<-filter(dt,X1==36,Y1==38,X2==2,Y2==2)
q21<-filter(dt,X1==36,Y1==38,X2==2,Y2==1)
...
my_text = pot("(36,38)", textProperties(color='black', font.size = 20,font.family = "Calibri") )
mytable<-addHeaderRow(mytable,value = c("","調查者：_________________________  紀錄者：___________  調查日期：__________\n電子輸入1：__________(      /   /   )   電子輸入2：__________(      /   /   )"),colspan=c(3,11),cell.properties=cellProperties(border.width = 0),text.properties = textProperties(font.size = 12,font.family = "Calibri"))
